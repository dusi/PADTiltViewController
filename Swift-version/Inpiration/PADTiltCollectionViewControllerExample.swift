//
//  PADTiltCollectionViewControllerExample.swift
//  Inpiration
//
...
class PADTiltCollectionViewControllerExample: PADTiltCollectionViewController, UIGestureRecognizerDelegate {
